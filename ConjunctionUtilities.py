...
def compute_TCA(X1, X2, trange, rso1_params, rso2_params,
    ...
    while b <= trange[1]:
        ...
        gvec, dum1, dum2, dum3, X1out, X2out, ti_out =  gvec_tudat(t0, tvec, X1, X2, rso1_params, rso2_params, bodies)
        # print('gvec', gvec)
        ...
        if len(troots) > 0:
            ...
            dum1, rvec, ivec, cvec, dum2, dum3, dum4 = gvec_tudat(t0, troots, X1, X2, rso1_params, rso2_params, bodies)
...
def gvec_tudat(t0, tvec, X1, X2, rso1_params, rso2_params, bodies):
    '''
    ...
    for ti in tvec:
        ...
        # if ti == tvec[0]:
            ...
            tin = [t0, ti]
            # tin = [tvec[0], ti]
            tout1, Xout1 = prop.propagate_orbit(X1, tin, rso1_params, bodies)
            tout2, Xout2 = prop.propagate_orbit(X2, tin, rso2_params, bodies)
